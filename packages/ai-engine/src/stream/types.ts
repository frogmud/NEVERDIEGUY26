...
/** Reaction types for stream entries */
export type ReactionType = 'love' | 'like' | 'dislike' | 'report';

/** A reaction from an NPC to a stream entry */
export interface StreamReaction {
  /** NPC slug who reacted */
  reactorSlug: string;
  /** Display name of reactor */
  reactorName: string;
  /** Type of reaction */
  type: ReactionType;
...
export interface StreamEntry {
  ...
  mentionsNPC?: string;
  /** For tagging: NPCs tagged with @ in this entry */
  taggedNPCs?: string[];
