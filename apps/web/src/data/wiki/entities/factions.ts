...
export const factions: Faction[] = [
  // Void Seekers - The One's followers
  {
    ...
    luckyNumber: 1,
    rarity: 'Epic',
    image: '/assets/factions/faction-icon-void-seekers.png',
  ...
  // Iron Collective - John's builders
  {
    ...
    luckyNumber: 2,
    rarity: 'Epic',
    image: '/assets/factions/faction-icon-iron-collective.png',
  ...
  // Shadow Court - Peter's undead
  {
    ...
    luckyNumber: 3,
    rarity: 'Epic',
    image: '/assets/factions/faction-icon-shadow-court.png',
  ...
  // Flame Wardens - Robert's pyromancers
  {
    ...
    luckyNumber: 4,
    rarity: 'Epic',
    image: '/assets/factions/faction-icon-flame-wardens.png',
  ...
  // Frost Heralds - Alice's frozen chosen
  {
    ...
    luckyNumber: 5,
    rarity: 'Epic',
    image: '/assets/factions/faction-icon-frost-heralds.png',
  ...
  // Verdant Order - Jane's naturalists
  {
    ...
    luckyNumber: 6,
    rarity: 'Epic',
    image: '/assets/factions/faction-icon-verdant-order.png',
  ...
  // Board Room - The elite guild
  {
    ...
    luckyNumber: 7,
    rarity: 'Legendary',
    image: '/assets/factions/faction-icon-board-room.png',
  ...
  // Wandering Stars - Independent travelers
  {
    ...
    luckyNumber: 0,
    rarity: 'Rare',
    image: '/assets/factions/faction-icon-wandering-stars.png',
