...
export const shops: Shop[] = [
  // The Wandering Market - Willy One Eye
  {
    ...
    luckyNumber: 5,
    rarity: 'Epic',
    portrait: '/assets/characters/portraits/120px/shop-portrait-willy-01.svg',
    sprites: ['/assets/market-svg/willy/shop-01.svg'],
  ...
  // Banco de Bones - Mr. Bones
  {
    ...
    luckyNumber: 5,
    rarity: 'Rare',
    portrait: '/assets/characters/portraits/120px/shop-portrait-mrbones-01.svg',
    sprites: ['/assets/market-svg/mr-bones/idle-01.svg'],
  ...
  // B's Hits - Boo G
  {
    ...
    luckyNumber: 6,
    rarity: 'Legendary',
    portrait: '/assets/characters/portraits/120px/shop-portrait-boog-01.svg',
    sprites: ['/assets/market-svg/boo-g/idle-01.svg'],
  ...
  // Null Throne Emporium - King James
  {
    ...
    luckyNumber: 1,
    rarity: 'Legendary',
    portrait: '/assets/characters/portraits/120px/shop-portrait-kingjames-01.svg',
    sprites: ['/assets/market-svg/king-james/shop-01.svg'],
  ...
  // The Burning Pages - Dr. Maxwell
  {
    ...
    luckyNumber: 4,
    rarity: 'Epic',
    portrait: '/assets/characters/portraits/120px/shop-portrait-maxwell-01.svg',
    sprites: ['/assets/market-svg/dr-maxwell/idle-01.svg'],
  ...
  // Command & Supply - The General
  {
    ...
    sprites: ['/assets/market-svg/the-general/idle-01.svg'],
  ...
  // Void Research Lab - Dr. Voss
  {
    ...
    luckyNumber: 1,
    rarity: 'Epic',
    portrait: '/assets/characters/portraits/120px/shop-portrait-voss-01.svg',
    sprites: ['/assets/market-svg/dr-voss/idle-01.svg'],
  ...
  // X-treme's X-change - X-treme
  {
    ...
    luckyNumber: 2,
    rarity: 'Epic',
    portrait: '/assets/characters/portraits/120px/shop-portrait-xtreme-01.svg',
    sprites: ['/assets/market-svg/xtreme/idle-01.svg'],
