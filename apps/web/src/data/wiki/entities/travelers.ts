...
export const travelers: Traveler[] = [
  // Never Die Guy - The protagonist
  {
    ...
    luckyNumber: 2,
    rarity: 'Legendary',
    portrait: '/assets/characters/travelers/never-die-guy.png',
    sprites: [
      '/assets/characters/travelers/sprite-never-die-guy-1.png',
      '/assets/characters/travelers/sprite-never-die-guy-2.png',
      '/assets/characters/travelers/sprite-never-die-guy-3.png',
      '/assets/characters/travelers/sprite-never-die-guy-4.png',
    ],
  ...
  // Stitch Up Girl - The healer sister
  {
    ...
    luckyNumber: 3,
    rarity: 'Legendary',
    portrait: '/assets/market/stitch-up-girl/portrait.png',
    sprites: [
      '/assets/market/stitch-up-girl/idle-01.png',
      '/assets/market/stitch-up-girl/idle-02.png',
    ],
  ...
  // The General - The undead strategist
  {
    ...
    luckyNumber: 2,
    rarity: 'Legendary',
    portrait: '/assets/market/the-general/portrait.png',
    sprites: [
      '/assets/market/the-general/idle-01.png',
      '/assets/market/the-general/idle-02.png',
      '/assets/market/the-general/idle-03.png',
    ],
  ...
  // Body Count - The silent assassin
  {
    ...
    luckyNumber: 6,
    rarity: 'Rare',
    portrait: '/assets/characters/travelers/body-count.png',
    sprites: [
      '/assets/characters/travelers/sprite-body-count-1.png',
      '/assets/characters/travelers/sprite-body-count-2.png',
      '/assets/characters/travelers/sprite-body-count-3.png',
      '/assets/characters/travelers/sprite-body-count-4.png',
    ],
  ...
  // Boots - The cosmic cat
  {
    ...
    rarity: 'Legendary',
    portrait: '/assets/characters/travelers/boots.png',
    sprites: [
  ...
  // Detective Clausen - The red-eyed detective
  {
    ...
    luckyNumber: 4,
    rarity: 'Epic',
    portrait: '/assets/characters/travelers/clausen.png',
    sprites: [
      '/assets/characters/travelers/sprite-clausen-1.png',
      '/assets/characters/travelers/sprite-clausen-2.png',
      '/assets/characters/travelers/sprite-clausen-3.png',
      '/assets/characters/travelers/sprite-clausen-4.png',
    ],
  ...
  // Keith Man - The time-dilated speedster
  {
    ...
    luckyNumber: 5,
    rarity: 'Epic',
    portrait: '/assets/market/keith-man/portrait.png',
    sprites: [
      '/assets/market/keith-man/idle-01.png',
      '/assets/market/keith-man/idle-02.png',
      '/assets/market/keith-man/walk-01.png',
    ],
  ...
  // Mr. Kevin - The reality debugger
  {
    ...
    luckyNumber: 1,
    rarity: 'Legendary',
    portrait: '/assets/characters/travelers/mr-kevin.png',
    sprites: [
      '/assets/characters/travelers/sprite-mr-kevin-1.png',
      '/assets/characters/travelers/sprite-mr-kevin-2.png',
      '/assets/characters/travelers/sprite-mr-kevin-3.png',
    ],
